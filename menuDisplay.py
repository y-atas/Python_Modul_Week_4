...
def displayMainMenu():
    print("\033[93m-" * 62)  # Sarı RENK KODU ICIN   \033[93m  ANSI escape kodları kullanılır.
    print("-"+ " "*9 + "HALK KUTUPHANESINE HOS GELDINIZ" + " "*9 +  " - ")
    print("-" + " "*50+"-")
    print("-"+ " "*9 + " 1 - UYELIK ISLEMLERI "+ " "* 10 + "1" + " " * 8 +"-")
...
def displaymembersMenu():
    print("\033[95m-" * 62, end="\n\n") # PEMBE 
    print(f"{'-':<3} {'UYELER':<15} {"= 1" :<5} {"=":<5} {"KITAP ODUNC VERME":<20} {"= 5":<5} {"-":>3}") 
